...
registry.register(domain.Client, models.Client, to_orm=map_client_to_orm, to_domain=map_client_to_domain,)
registry.register( domain.Seller, models.Seller, to_orm=map_seller_to_orm, to_domain=map_seller_to_domain)
registry.register(domain.User, models.User, to_orm=map_user_to_orm, to_domain=map_user_to_domain,)
