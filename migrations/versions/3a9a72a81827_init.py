...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "status_name IN ('pending', 'approved', 'rejected')",
    ...
    op.create_index(
        "idx_product_fts",
        "products",
        [sa.literal_column("to_tsvector('russian', description)")],
        unique=False,
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "status_name IN ('pending_payments', 'paid', 'canceled')",
    ...
    op.create_table(
        ...
        sa.Column("status_name", sa.String(), nullable=False),
        sa.CheckConstraint(
            "status_name IN ('available', 'reserved', 'sold', 'compromised')",
